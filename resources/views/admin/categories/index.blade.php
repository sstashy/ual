...
<div class="page-header">
    <div class="row align-items-center">
        ...
        <div class="col-auto ml-auto d-print-none">
            <a href="{{ url('admin/category/add') }}" class="btn btn-primary btn-sm d-sm-inline-block">
        ...
        <div class="card">
                ...
                <table class="table card-table table-vcenter text-nowrap datatable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-list">
                                    <a href="{{ url('admin/category/edit/'.$item->id) }}" class="btn btn-sm">Edit</a>
            ...
            <div class="card-footer d-flex align-items-center">
                <p class="m-0 text-muted">
                    Showing {{ $categories->currentPage() }} page of {{ $categories->total() }} entries
                </p>
