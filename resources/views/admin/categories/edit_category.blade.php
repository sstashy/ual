...
<div class="row row-deck row-cards">
    <div class="col-lg-12">
        ...
        <div class="card">
            ...
            <form method="post" action="{{ url('admin/category/edit/'.$item->id) }}">
                <div class="card-body">
                    @csrf
                    ...
                    <div class="form-group mb-3 row">
                        ...
                        <div class="col">
                            <input type="text" class="form-control @error('description') is-invalid @enderror" value="{{ !empty(old('description')) ? old('description') : $item->description }}" name="description">
