...
<div class="row row-deck row-cards">
    <div class="col-lg-12">
        ...
        <div class="card">
            ...
            <form method="post" action="{{ url('admin/page/edit/'.$item->id) }}">
                <div class="card-body">
                    @csrf
                    ...
                    <div class="form-group mb-3 row">
                        ...
                        <div class="col">
                            <textarea class="form-control @error('body') is-invalid @enderror" name="body" rows="15">{{ !empty(old('body')) ? old('body') : $item->body }}</textarea>
