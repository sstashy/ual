...
<div class="row row-deck row-cards">
    <div class="col-lg-12">
        <div class="card">
            <form method="post" action="{{ url('admin/adv/add') }}">
                <div class="card-body">
                    @csrf
                    ...
                    <div class="form-group mb-3 row">
                        ...
                        <div class="col">
                            <textarea class="form-control @error('adv') is-invalid @enderror" name="adv" rows="8" placeholder="Enter the code here">{{ old('adv') }}</textarea>
