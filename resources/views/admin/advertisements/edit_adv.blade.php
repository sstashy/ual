...
<div class="page-header">
    <div class="row align-items-center">
        ...
        <div class="col-auto ml-auto d-print-none">
            <a href="{{ url('admin/advertisements') }}" class="btn btn-primary btn-sm d-sm-inline-block">
...
<div class="row row-deck row-cards">
    <div class="col-lg-12">
        ...
        <div class="card">
            ...
            <form method="post" action="{{ url('admin/adv/edit/'.$item->id) }}">
                <div class="card-body">
                    @csrf
                    ...
                    <div class="form-group mb-3 row">
                        ...
                        <div class="col">
                            <textarea class="form-control @error('adv') is-invalid @enderror" name="adv" rows="8">{{ !empty(old('adv')) ? old('story') : $item->adv }}</textarea>
